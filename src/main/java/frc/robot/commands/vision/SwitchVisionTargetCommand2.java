...
public class SwitchVisionTargetCommand2 extends InstantCommand {
     ...
     */
    public SwitchVisionTargetCommand2(VisionSubsystem visionSubsystem) {
     ...
     * @param visionSubsystem
     */
    public SwitchVisionTargetCommand2(VisionTargetType visionTargetType, VisionSubsystem visionSubsystem) {
